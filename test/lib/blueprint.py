...
# blueprint = Blueprint("/usr/local/google/home/nanyu/projects/anthos-blueprints", "anthos-service-mesh-packages-release-1.5-asm")
...
#
# print(dict(filter(lambda item: not item[1].is_patch, blueprint.packages.items())))